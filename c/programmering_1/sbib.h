...
void terminal_print_out_menu(std::string title, std::string information, int size);
void terminal_print_out_menu(std::string title[], std::string * information, int size, int halt[]);
void terminal_print_out_menu(std::string title[], std::string information, int size, int halt[]);

void terminal_print_out_yes_no(std::string question);
